...
if __name__ == '__main__':
  ...
  print("This code turns a SCENE000x file into a written prose scene.")
  ...
  while True:  #start a new scene
    ...
    filename = "PROSE_SCENE"+previousscenenumber+".txt"
    print("prose we're looking for:"+filename)
    ...
    folder = "planprompts/"
    filepath = os.path.join(folder, "proseexample.txt")
    with open(filepath, "r", encoding='utf-8') as f:
    ...
    #load prompts
    folder = "planprompts/"
    filepath = os.path.join(folder, "proseprompt.txt")
    with open(filepath, "r", encoding='utf-8') as f:
         prompt = f.read()
    ...
    while True:
                ...
                print(completion)
                filepath = os.path.join(folderpath, "PROSE_"+scenename)
