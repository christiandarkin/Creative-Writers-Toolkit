...
if __name__ == '__main__':
  ...
  print("This code turns a SCENE00x file into a movie script scene.")
  ...
  while True:  #start a new scene
    ...
    previousscenenumber=three_digit_string(scenenumber-1)
    ...
    if tobewrittenscenes >0:
        tbw=three_digit_string(tobewrittenscenes)
    ...
    if nxt !="n":
      ...
      snum= three_digit_string(scenenumber)
      filename = "SCENE"+snum+".txt"
      print(filename)
      filepath = os.path.join(folderpath, filename)
      if isFileExists(filepath):
